...
---
<a id='login'></a>
## 5. 🌍 Пароли и логины для входа и тестирования приложения
...
> Меню для просмотра своих вакансий с возможностью обновления, публикации/снятия с публикации, редактирования и удаления
